...
//  PizzaWorld
//
//  Created by Shadi Elattar on 7/22/21.
//
...
class CustomTabBar: UITabBar {
    ...
    private let waveSubLayer: CAShapeLayer = {
        ...
        subLayer.strokeColor = #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 0.1)
...
extension UIBezierPath{
    class func createCurve(at center: CGFloat, radius curve: CGFloat, on tabBar: UITabBar) -> UIBezierPath{
        ...
        path.addQuadCurve(to: CGPoint(x: center - curve , y: curve / 1.4),
